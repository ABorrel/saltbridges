...
def retriveDataSetFile(directory_in):
    ...
    for filin in list_files:
        if search("dataset", filin) and search(".txt", filin) and not search("RMN", filin) and not search("NMR",
                                                                                                          filin) and not search(
                "OUT", filin) and not search("~", filin):
